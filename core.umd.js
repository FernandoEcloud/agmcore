...
var MarkerManager = (function () {
    ...
    // MarkerManager.prototype.updateMarkerPriceFrom = function (marker) {
    //     return this._markers.get(marker).then(function (m) { return m.setPosition({ lat: marker.latitude, lng: marker.longitude }); });
    // };
...
AgmMarker.propDecorators = {
    'latitude': [{ type: _angular_core.Input },],
    'priceFrom': [{ type: _angular_core.Input },],
    'longitude': [{ type: _angular_core.Input },],
    ...
    'labelContent': [{ type:  _angular_core.Input },] ,
    'labelAnchor': [{ type:  _angular_core.Input },],
    'labelClass': [{ type:  _angular_core.Input },],  // the CSS class for the label
    'labelInBackground': [{ type:  _angular_core.Input },],
    'labelStyle': [{ type:  _angular_core.Input },],
